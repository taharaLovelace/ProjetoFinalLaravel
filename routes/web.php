...
//ROTAS DE ALUNOS
Route::get('/alunos/dashboard', [AlunosController::class, 'index'])->middleware('alunos');                    //dashboard principal alunos
...
Route::get('/secretaria/cursos', [CursosController::class, 'view'])->middleware('secretaria');
